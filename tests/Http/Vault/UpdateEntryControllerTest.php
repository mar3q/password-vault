...
final class UpdateEntryControllerTest extends ApiTestCase
{
    #[Test]
    public function it_updates_an_entry(): void
    {
        $this->registerUser();
        ...
        $this->client->jsonRequest('PUT', '/api/vault/' . $entryId, [
            'title' => 'GitLab',
            'password' => 'new-secret',
            'login' => 'user@gitlab.com',
        ], server: $this->authServer($token));
        ...
        self::assertSame('GitLab', $json['title']);
        self::assertSame('new-secret', $json['password']);
        self::assertSame('user@gitlab.com', $json['login']);
    }
    ...
    public function it_returns_404_for_unknown_entry(): void
    {
        ...
        $this->client->jsonRequest('PUT', '/api/vault/00000000-0000-4000-8000-000000000000', [
            'title' => 'Test',
            'password' => 'secret',
        ], server: $this->authServer($token));
    ...
    public function it_returns_403_for_other_users_entry(): void
    {
        ...
        $this->client->jsonRequest('PUT', '/api/vault/' . $entryId, [
            'title' => 'Hacked',
            'password' => 'hacked',
        ], server: $this->authServer($attackerToken));
